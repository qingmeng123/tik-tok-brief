...
func (c *chatClient) GetHistoryMessage(ctx context.Context, in *GetHistoryMessageReq, opts ...grpc.CallOption) (*GetHistoryMessageResp, error) {
	out := new(GetHistoryMessageResp)
	err := c.cc.Invoke(ctx, "/chat.chat/GetHistoryMessage", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Chat_GetHistoryMessage_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetHistoryMessageReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ChatServer).GetHistoryMessage(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/chat.chat/GetHistoryMessage",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ChatServer).GetHistoryMessage(ctx, req.(*GetHistoryMessageReq))
	}
	return interceptor(ctx, in, info, handler)
}
